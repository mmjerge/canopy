...
| 2 | MBPP, multi-test execution probe | `examples/reasoning/mbpp_probe_check.py` (probe: `canopy.bandits.code_eval.public_fraction`; gate: `probe_truth_pairs`) | built; needs AWS to run |
